...
import com.example.zx.myapplication.imgloader.SisterCompress;
import com.example.zx.myapplication.imgloader.disklrucache.DiskLruCache;
...
public class DiskCacheHelper {
    ...
    private static final long DISK_CACHE_SIZE = 1024 * 1024 * 50;//设置磁盘缓存区的大小
    ...
    public Bitmap loadBitmapFromDiskCache(String key, int reqWidth, int reqHeight) throws IOException{
        ...
        if(Looper.myLooper() == Looper.getMainLooper()){
            throw new RuntimeException("不能做UI线程中加载图片");
        }
